...
for HOSTNAME in ${HOSTS} ; do
    ...
    ssh -i ${KEYPAIR_PATH}/${USERNAME}-keypair ${USERNAME}@${HOSTNAME} "pkill -u ${USERNAME} -f '^python3 ${PROCESS_TO_KILL} 8012$' && rm /home/ahameed/project-4---final-project-zane-danny-ahmed/serverOutput.out"
done
