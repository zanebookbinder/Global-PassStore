...
for HOSTNAME in ${HOSTS} ; do
    ...
    ssh -i ~/.ssh/$USER-keypair $USER@${HOSTNAME} "pkill -u $USER -f '^python3 server.py 8061$' && cd project-4---final-project-zane-danny-ahmed && git pull && python3 server.py ${PORTNO} &" &
